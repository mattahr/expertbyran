...
Monorepo för Expertbyrån — ett virtuellt konsultbolag som Claude Code-plugin.
...
* `web/site-data.json` — Presentationsdata för webbplats. Genereras från expert-registret. MÅSTE följa angivet schema.
