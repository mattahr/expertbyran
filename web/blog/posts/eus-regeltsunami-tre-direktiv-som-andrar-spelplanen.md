...
NIS2-direktivet är, enligt regeringens egen beskrivning, "den mest omfattande ambitionshöjningen inom EU:s cybersäkerhetslagstiftning hittills". Till skillnad från det tidigare NIS-direktivet från 2016 omfattar det nya regelverket betydligt fler sektorer och aktörer — inklusive stora delar av den offentliga förvaltningen.
...
Parallellt med cybersäkerhetskraven har EU:s hållbarhetsrapporteringsdirektiv (CSRD) börjat gälla. I Sverige uppskattas 1 600–2 000 stora företag omfattas av de nya kraven, enligt SOU 2023:35 *Nya regler om hållbarhetsredovisning* ([läs här](https://data.riksdagen.se/dokument/HBB335.html)).

Skillnaden mot tidigare är markant. Hållbarhetsrapporten ska nu:

- Följa EU-gemensamma standarder (ESRS) för jämförbarhet
- Granskas av revisor — inte bara bekräftas som upprättad
- Omfatta hela värdekedjan, inklusive leverantörers påverkan
- Vara digital och maskinläsbar

Komplexiteten har lett till att EU-kommissionen själv överväger förenklingar, och Sverige har skjutit upp kraven med två år för vissa företag ([prop. 2025/26:21](https://data.riksdagen.se/dokument/HD0321.html)). Det pekar på ett underliggande problem: kraven är ambitiösa, men kapaciteten att efterleva och granska dem släpar efter.

## Tre utmaningar som gör granskning svår

Vart och ett av dessa regelverk är komplext nog. Men det är kombinationen som skapar den verkliga utmaningen.

**Överlappande krav med olika logik.** Cybersäkerhetslagen fokuserar på riskhantering och incidentrapportering. CSRD fokuserar på transparens och dubbel väsentlighet. CER-direktivet handlar om fysisk motståndskraft. En organisation som bedriver samhällsviktig verksamhet kan behöva uppfylla alla tre samtidigt — med olika tillsynsmyndigheter, rapporteringsformat och tidsfrister.

**Kompetensbrist i både genomförande och tillsyn.** Utredningen om cybersäkerhet (SOU 2024:18, [läs här](https://data.riksdagen.se/dokument/HCB318.html)) pekar på att det krävs betydande resurstillskott för tillsynsmyndigheterna. Inom hållbarhetsrapportering saknas det redan revisorer med rätt kompetens. Bristen är dubbel: organisationerna har svårt att implementera, och tillsynen har svårt att följa upp.
...
- [Prop. 2025/26:28 — Ett starkt skydd för nätverks- och informationssystem: en ny cybersäkerhetslag](https://data.riksdagen.se/dokument/HD0328.html)
- [SOU 2024:18 — Nya regler om cybersäkerhet](https://data.riksdagen.se/dokument/HCB318.html)
- [SOU 2023:35 — Nya regler om hållbarhetsredovisning](https://data.riksdagen.se/dokument/HBB335.html)
- [Prop. 2025/26:21 — Uppskjutet krav på hållbarhetsrapportering](https://data.riksdagen.se/dokument/HD0321.html)