...
Tillitskrisen förstärks från ett annat håll. Deepfakes — AI-genererade förfalskningar av ljud, bild och video — har nått en kvalitet där artefakter inte längre syns med blotta ögat. Inför Irlands presidentval 2025 spreds en [deepfake av en kandidats återkallelse](https://www.euronews.com/next/2025/01/21/deepfakes-and-the-irish-election) dagarna före valet.

Det mest svårhanterliga hotet kallas *Liar's Dividend*: möjligheten att avfärda *autentiska* bevis som AI-genererade. En tjänsteperson som konfronteras med ett protokoll kan hävda att det är fabricerat. En myndighet vars interna kommunikation läcker kan ifrågasätta äktheten. Revisionens grundläggande funktion — att verifiera, kontrollera och dokumentera — vilar på att bevis går att lita på. Den grunden urholkas.

EU:s AI-förordning kräver märkning av AI-genererat innehåll från augusti 2026, med sanktioner upp till [sex procent av global omsättning](https://artificialintelligenceact.eu/article/50/). Märkningskrav adresserar dock inte Liar's Dividend — det fenomenet handlar om att autentiskt material avfärdas, inte om att fejkat material saknar etikett.

## EU AI Act adresserar inte agent-till-agent-tillit

EU:s AI-förordning är den mest ambitiösa AI-regleringen i världen. Den ställer krav på riskhanteringssystem, teknisk dokumentation, automatisk loggning och mänsklig tillsyn för högrisk-AI. Däremot adresserar den inte agent-till-agent-tillit.
...
## Tekniska byggstenar finns — sammansatt ramverk saknas

Trots det regulatoriska vakuumet finns tekniska mekanismer som kan utgöra grunden för ett KYA-ramverk:

- **Kryptografisk arbetsbelastningsidentitet.** [SPIFFE/SPIRE](https://spiffe.io/) ger kryptografisk attestation av vilken mjukvara som kör vad. Tekniken används i produktion av bland andra Netflix och Google. Den har hög teknisk mognad för molnmiljöer — men har inte porterats till AI-agenter i offentlig sektor.
...
Byggstenarna finns. Det som saknas är ett sammanhållet ramverk med regulatoriskt stöd.

## Fem rekommendationer för svensk offentlig sektor

Att vänta på att EU löser frågan innebär att agentisk AI sprids i fyra år utan grundläggande förtroendemekanismer. Sverige kan agera redan nu.
...
2. **Signera.** Kryptografisk signering av agentoutputs i system som påverkar enskilda skapar spårbarhet utan att kräva full systemombyggnad.
...
5. **Ställ krav i upphandlingen.** Obligatoriska audit-hooks i all offentlig IT-upphandling är en central åtgärd för att bygga den infrastruktur som revision kräver. Brasiliens revisionsmyndighet [TCU](https://portal.tcu.gov.br/en_us/) halvautomatiserade revision genom att kräva dataaccesskontrakt med granskade myndigheter.
...
Know Your Agent är inte ett färdigt ramverk. Det är ett sätt att ställa den grundläggande frågan: är det känt vem — eller vad — som fattar besluten?
